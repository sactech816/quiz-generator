    ...
    for k, v in data.get('results', {}).items():
        ...
        if v.get('line_url'):
            ...
            <div class="line-section">
                <p class="line-title">🎁 無料プレゼント！</p>
                <p class="line-desc">{v.get('line_text', '公式LINE登録で詳細解説をプレゼント中！')}</p>
                {img_tag}
                <a href="{v['line_url']}" target="_blank" class="line-btn">LINEで受け取る</a>
            </div>
            """
