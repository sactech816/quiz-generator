...
# --- 🆑 ポータル & 作成 ---
    ...
    # (createモードは前回と変更なしのため、そのままでOKです)
        ...
        with st.sidebar:
            ...
            if st.button("AIで構成案を作成", type="primary"):
                try:
                    ...
                    出力JSONフォーマット:
                    {{
                        "page_title": "", "main_heading": "", "intro_text": "",
                        "image_keyword": "英単語1語(例: business)",
                        "results": {{
                            "A": {{ "title": "", "desc": "詳細解説(600字)", "btn": "", "link":"" }},
                            "B": {{ "title": "", "desc": "詳細解説(600字)", "btn": "", "link":"" }},
                            "C": {{ "title": "", "desc": "詳細解説(600字)", "btn": "", "link":"" }}
                        }},
                        "questions": [
        ...
        with st.form("editor"):
            ...
            c1, c2 = st.columns(2); sub_free = c1.form_submit_button("🌐 無料公開", type="primary"); is_pub = c2.checkbox("ポータル掲載"); sub_paid = c2.form_submit_button("💾 980円で購入")
