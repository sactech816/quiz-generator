...
# --- テンプレート定義 (エラー回避のためf-stringを使わず定義) ---
...
# --- 🆑 ポータル & 作成画面 ---
    ...
    st.markdown("""
        ...
        .portal-card { background: white; border: 1px solid #e2e8f0; border-radius: 12px; padding: 20px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); height: 100%; }
