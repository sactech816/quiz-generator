...
# --- 🆑 ポータル & 作成画面 ---
    ...
    # ★エディタ画面は強制ダークモード(Streamlitデフォルト)を使用
    # 特に追加CSSを書かなければ、自動的にダーク系の標準デザインになります
    # (もし白くなってしまう場合は、ユーザー設定でDark Modeを選んでもらうか、以下で強制します)
    st.markdown("""
        <style>
        /* エディタ画面用のダークモード強制 (必要であれば) */
        .stApp {
